        ...
        <Transition.Root show={sidebarOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-yellow-50 pt-5 pb-4 dark:bg-gray-800">
                  <Transition.Child
                    as={Fragment}
                        ...
                        <Link
                          ...
                          className={clsx(
                            asPathWithoutLang === item.href
                              ? 'bg-yellow-100 text-gray-900 dark:bg-gray-900 dark:text-white'
                              : 'text-gray-700 hover:bg-yellow-100 dark:text-gray-50 dark:hover:bg-gray-900',
            ...
            <div className="flex flex-1 justify-between px-4">
              ...
              <div className="ml-4 flex items-center gap-3 lg:ml-6">
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="flex max-w-xs items-center rounded-full text-sm text-gray-700 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:text-gray-50 dark:hover:text-gray-200 dark:hover:text-gray-200">
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-yellow-100 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-900">
                            ...
                            <a
                              ...
                              className={clsx(
                                active
                                  ...
                                  : '',
                                'block rounded-sm px-4 py-2 text-sm text-gray-700 dark:text-gray-50'
                              )}
                            >
                              {t(item.name)}
                            </a>
