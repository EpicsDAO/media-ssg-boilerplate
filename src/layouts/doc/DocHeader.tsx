          ...
          {({ close }) => (
            <>
              <div className="flex items-center justify-between p-6 md:justify-start md:space-x-10">
                ...
                <Popover.Group as="nav" className="hidden space-x-10 md:flex">
                  {defaultMainNav.map((nav) => (
                    <Link
                      key={`${nav.name} DocHeader.defaultMainNav`}
                      href={nav.href}
              ...
              >
                ...
                >
                  <div className="rounded-lg bg-yellow-50 shadow-lg ring-1 ring-black ring-opacity-5 dark:bg-gray-800">
                    ...
                    <div className="py-8 px-5">
                      <div className="grid grid-cols-1 gap-8">
                        {defaultMainNav.map((nav) => (
                          <Link
                            key={`${nav.name} DocHeader.defaultMainNav.mobile`}
                            href={nav.href}
